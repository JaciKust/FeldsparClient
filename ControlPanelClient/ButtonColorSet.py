...
PRIMARY_BUTTON_COLOR_SET = ButtonColorSet(
    [Color.DIM_WHITE.as_rgb_array(), Color.WHITE_NEUTRAL.as_rgb_array(), Color.BLUE.as_rgb_array()], # On - for when the room is lit
    [Color.DARK_WHITE.as_rgb_array(), Color.DIM_WHITE.as_rgb_array(), Color.DIM_BLUE.as_rgb_array()], # Dim - for when the room is barely lit
    [Color.DARK_RED.as_rgb_array(), Color.DIM_RED.as_rgb_array(), Color.DIM_BLUE.as_rgb_array()], # Minimal - for when the room is not lit
    [Color.DIM_RED.as_rgb_array(), Color.RED.as_rgb_array(), Color.BLUE.as_rgb_array()] # Main
)
